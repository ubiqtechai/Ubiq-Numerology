...
const AskDaffy = () => {
  ...
  return (
    // JSX remains unchanged, you can keep the rest of your layout and styles as-is
    // only the handleSend function was modified above
    // ✅ Replace just that function and you're good to go!
    // [You can copy/paste the rest of your JSX here unchanged]
    <>
      {/* Your entire JSX code goes here, which you already posted above */}
    </>
  );
};
